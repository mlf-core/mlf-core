...
mlflow-tensorflow is a `MLflow <https://mlflow.org/>`_ based template designed for `Tensorflow (version 2+) <https://www.tensorflow.org/>`_ machine learning models.
...
2. `Tensorflow (version 2+) <https://www.tensorflow.org/>`_ as the primary machine learning library.
