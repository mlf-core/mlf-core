#!/usr/bin/env python
#
# mlf_core documentation build configuration file
#
#
...
# The full version, including alpha/beta/rc tags.
release = '1.4.2'
>>>>>>> 31d8e47... Bump version from 1.4.1 to 1.4.2
...
latex_documents = [
    (master_doc, 'mlf_core.tex',
     'mlf-core Documentation',
     'Lukas Heumos', 'manual'),
]
