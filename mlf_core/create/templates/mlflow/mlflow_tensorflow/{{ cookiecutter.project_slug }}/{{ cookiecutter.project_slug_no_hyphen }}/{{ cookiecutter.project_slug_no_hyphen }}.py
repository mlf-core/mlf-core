...
@click.option('--max_epochs', type=int, default=10, help='Number of epochs to train')
...
def start_training(cuda, max_epochs, general_seed, tensorflow_seed, batch_size, buffer_size, lr):
    ...
    with mlflow.start_run():
        ...
        with strategy.scope():
            ...
            runtime = time.time()
            train(model, max_epochs, train_dataset)
