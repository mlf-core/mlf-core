...
class HelpErrorHandling(click.Group):
    ...
    def format_help(self, ctx, formatter):
        """
        Call format_help function with mlf-core customized functions.
        """
    ...
    def format_usage(self, ctx, formatter):
        ...
        """
        formatter.write_text(f'{self.get_rich_value("Usage:")} mlf-core {" ".join(super().collect_usage_pieces(ctx))}')
...
class CustomHelpSubcommand(click.Command):
    ...
    def format_help(self, ctx, formatter):
        ...
        Use the overwritten format functions this class provides to output help for each subcommand mlf-core provides.
        """
        formatter.width = 120
        self.format_usage(ctx, formatter)
