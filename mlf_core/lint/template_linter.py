...
class TemplateLinter(object):
    ...
    def mlflow_mlf_core_py_complete(self) -> None:
        ...
        expected_lines_sys_intell_conda_env = ['def log_sys_intel_conda_env():',
                                               ...
                                               f'subprocess.call([\'conda\', \'env\', \'export\','
                                               f' \'--name\', \'{self.project_slug}\'], stdout=conda_env_filehandler)',
                                               f'mlflow.log_artifact(f\'{{reports_output_dir}}/'
                                               f'{self.project_slug}_conda_environment.yml\', artifact_path=\'reports\')']
