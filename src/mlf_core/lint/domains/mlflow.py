...
from src.mlf_core.lint.template_linter import files_exist_linting
from src.mlf_core.lint.template_linter import GetLintingFunctionsMeta
...
class MlflowPytorchLint(TemplateLinter, metaclass=GetLintingFunctionsMeta):
    ...
    def pytorch_files_exist(self) -> None:
        ...
        files_fail = [["MLproject"], ["environment.yml"], [f"{self.project_slug_no_hyphen}/mlf_core/mlf_core.py"]]
    ...
    def pytorch_reproducibility_seeds(self) -> None:
        ...
        expected_lines_pytorch_reproducibility = ["trainer.deterministic = True", "trainer.benchmark = False"]

        expected_lines_pytorch_mlf_core = [
...
class MlflowTensorflowLint(TemplateLinter, metaclass=GetLintingFunctionsMeta):
    ...
    def tensorflow_reproducibility_seeds(self) -> None:
        ...
        expected_lines_tensorflow_reproducibility = [
    ...
    def tensorflow_non_deterministic_functions(self) -> None:
        ...
        """
        non_deterministic_tf_functions = [
...
class MlflowXGBoostLint(TemplateLinter, metaclass=GetLintingFunctionsMeta):
    ...
    def xgboost_reproducibility_seeds(self) -> None:
        ...
        expected_lines_xgboost_reproducibility = [
            'MLFCore.set_general_random_seeds(dict_args["general_seed"])',
...
def verify_method_not_present(calling_class: TemplateLinter, functions_to_check: list, linting_code: str):
    ...
    for root, _, files in os.walk(f"{calling_class.path}/{calling_class.project_slug_no_hyphen}"):
        for file in files:
            if file.endswith(".py"):
